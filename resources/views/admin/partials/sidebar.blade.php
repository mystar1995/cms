...
<aside id="sidebar-wrapper">
  ...
  <ul class="navbar-nav mr-3" style="width: 100%">
   ...
   <!--  <li><a href="#" data-toggle="search" class="nav-link nav-link-lg d-sm-none"><i class="fas fa-search"></i></a></li> -->
      ...
      <li><button class="collapsible"><i class="ms-Icon ms-font-lg ms-Icon--DelveAnalyticsLogo" style="margin-left: 5px;color: #848b90"></i><span class="ms-Label" style="font-size: 14px;display: unset;padding-left:22px;">Open Collapsible</span></button>
